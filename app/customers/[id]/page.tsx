...
function getRevenueByCurrency(orders: Order[]) {
...
export default function CustomerProfilePage() {
  ...
  const [orders, setOrders] =
    useState<Order[]>([]);
  const revenueByCurrency = getRevenueByCurrency(orders);
