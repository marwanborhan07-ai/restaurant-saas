...
export default function OrdersPage() {
  ...
  function openEditForm(order: Order) {
    ...
    setCurrencyCode(order.currency_code || restaurantCurrency);
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <div className="mt-3 space-y-2">
                {Object.entries(stats.revenueByCurrency).length === 0 ? (
                  ...
                  Object.entries(stats.revenueByCurrency).map(
                    ([currency, amount]) => (
                      <div
                        key={currency}
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <div className="rounded-xl bg-blue-100 px-4 py-3 text-xl">{"\uD83D\uDCE6"}</div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <div className="rounded-xl bg-green-100 px-4 py-3 text-xl">{"\u2713"}</div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <div className="rounded-xl bg-yellow-100 px-4 py-3 text-xl">{"\u23F3"}</div>
              </div>
            </div>
