          ...
          <div className="lg:col-span-2 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-xl border bg-gray-50 p-5">
                ...
                <p className="mt-2 text-xs text-gray-400">
                  Scheduling creates a recipient queue for the currently selected audience. Actual delivery still depends on the connected provider.
                </p>
          ...
          <div className="rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 rounded-xl border border-yellow-200 bg-yellow-50 p-4">
              ...
              <p className="text-sm font-medium text-yellow-800">
                Delivery is provider-dependent
              </p>

              <p className="mt-1 text-xs leading-5 text-yellow-700">
                Scheduling creates queue records for the selected customers. Actual WhatsApp, SMS, or Email delivery will only happen when the corresponding provider execution layer is connected.
              </p>
