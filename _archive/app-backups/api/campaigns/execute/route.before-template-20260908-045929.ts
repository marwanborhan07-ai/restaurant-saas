...
async function sendWhatsAppTemplate(
  ...
  console.log(
    "[WHATSAPP TEMPLATE] tokenLength:",
    accessToken.length
  );
  console.log(
    "[WHATSAPP TEMPLATE] phoneNumberId:",
    phoneNumberId
  );
  console.log(
    "[WHATSAPP TEMPLATE] apiVersion:",
    apiVersion
  );
  console.log(
  ...
  try {
    ...
    console.error(
      "[WHATSAPP TEMPLATE] FETCH ERROR:",
      errorMessage
    );

    throw new Error(
      `WhatsApp fetch error: ${errorMessage}`
    );
  }
  ...
  console.log(
    "[WHATSAPP TEMPLATE] Meta HTTP status:",
    response.status
  );

  console.log(
    "[WHATSAPP TEMPLATE] Meta response:",
    JSON.stringify(data)
  );
